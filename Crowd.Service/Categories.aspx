    ...
    <form id="form1" runat="server">
        <div>
            ...
            <asp:GridView ID="gvCategories" runat="server" AutoGenerateColumns="False"
                DataKeyNames="Id" OnRowCancelingEdit="gvCategoreis_RowCancelingEdit"
                OnRowEditing="gvCategories_RowEditing" OnRowUpdating="gvCategories_RowUpdating">
                <Columns>
                    <asp:TemplateField>
                        <ItemTemplate>
                            <asp:HyperLink ID="lnkActionId" runat="server" Text='<%# Eval("Id") %>' NavigateUrl='<%# "activities.aspx?id=" + Eval("Id") %>'></asp:HyperLink>
                        </ItemTemplate>
                    </asp:TemplateField>
