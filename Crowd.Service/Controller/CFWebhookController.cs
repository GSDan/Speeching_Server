...
namespace Crowd.Service.Controller
{
    public class CFWebhookController : BaseController, ICFWebhookController
    {
        ...
        public async Task<HttpResponseMessage> Post()
        {
            ...
            CFWebhook realData = JsonConvert.DeserializeObject<CFWebhook>(await req.Content.ReadAsStringAsync());
            //string realData = (await req.Content.ReadAsFormDataAsync())["payload"];
            ...
            CFResponseData cfData = JsonConvert.DeserializeObject<CFResponseData>(realData.payload);
